...
<section class="content">
    ...
    <div class="box box-primary collapsed-box">
       ...
       <!--<div class="box-body">
            <dl>
                <dd>
                    Dengan menggunakan CBT, maka anda setuju untuk :
                    <ol>
	...
	<div class="callout callout-info">
    	<h4>Informasi</h4>
        <p>Ini adalah area administratif Test Leveling Tax Center Gunadarma, yang memiliki platform dan bahasa user-friendly untuk membuat, mengelola dan melaksanakan ujian online.</p>
    </div>
    <div class="box">
        <div class="box-header with-border">
