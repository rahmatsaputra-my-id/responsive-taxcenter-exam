  ...
  <body class="skin-green sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <!-- Logo -->
        <a href="<?php echo site_url(); ?>/manager" class="logo" style="background-color: #0c2461">
          <!-- mini logo for sidebar mini 50x50 pixels -->
          <span class="logo-mini" ><b>TC</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Tax Center UG</b></span>
        </a>

        <!-- Header Navbar: style can be found in header.less -->
        <nav class="navbar navbar-static-top" role="navigation" style="background-color: #0c2461">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header" style="background-color: #0c2461">
      ...
      <footer class="main-footer">
        ...
        <strong>&copy; 2019 Alfharizky Fauzi</strong>
      </footer>
